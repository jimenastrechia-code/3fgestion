...
const LOGO_3F = "data:image/png;base64,";

const USERS = [
  { id:"sofi",  name:"Sofi",  avatar:"S", color:"#8b5cf6" },
  { id:"andre", name:"Colo", avatar:"C", color:"#6366f1" },
  { id:"axel",  name:"Axel",  avatar:"A", color:"#0ea5e9" },
  { id:"joaco", name:"Joaca", avatar:"J", color:"#10b981" },
];
...
function EditLiceoModal({student,onConfirm,onCancel}) {
  const [liceo,setLiceo]=useState(student.liceo||"");
  return <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.45)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
    <div style={{background:"#fff",borderRadius:16,padding:"24px",width:"100%",maxWidth:360,boxShadow:"0 8px 40px rgba(0,0,0,.18)"}}>
      <div style={{fontSize:15,fontWeight:700,color:"#111827",marginBottom:4}}>Editar Liceo</div>
      <div style={{fontSize:13,color:"#6b7280",marginBottom:16}}>{student.name}</div>
      <input autoFocus value={liceo} onChange={e=>setLiceo(e.target.value)} onKeyDown={e=>e.key==="Enter"&&onConfirm(liceo.trim())}
        placeholder="Ej: Crandon"
        style={{width:"100%",padding:"9px 12px",borderRadius:8,border:"1.5px solid #8b5cf6",fontSize:14,fontFamily:"inherit",color:"#111827",boxSizing:"border-box",outline:"none",marginBottom:16}}/>
      <div style={{display:"flex",gap:8}}>
        <button onClick={onCancel} style={{flex:1,padding:"8px",border:"1px solid #e5e7eb",background:"transparent",color:"#6b7280",borderRadius:8,cursor:"pointer",fontSize:13}}>Cancelar</button>
        <button onClick={()=>onConfirm(liceo.trim())} style={{flex:2,padding:"8px",background:"#8b5cf6",color:"#fff",border:"none",borderRadius:8,cursor:"pointer",fontSize:13,fontWeight:700}}>Guardar</button>
      </div>
    </div>
  </div>;
}
...
function AsignadasView({uid,items,visits,students,assignedOutItems,resolveItem,addComment,deleteComment,editItemText,resolveAssignedItem,addCommentAssigned,deleteCommentAssigned,editAssignedItemText,deleteAssignedItem}) {
  const [tab,setTab]=useState("porme");
  const assignedToMe=items.filter(i=>i.assignedBy);
  const assignedByMe=assignedOutItems;
  const sortPrio=(a,b)=>{const po={alta:0,media:1,baja:2};return (po[a.priority]??1)-(po[b.priority]??1);};
  return <div style={{padding:"28px",maxWidth:760}}>
    ...
    {tab==="porme"&&<>{assignedByMe.length===0
      ?<div style={{textAlign:"center",padding:"48px",color:"#9ca3af",fontSize:14,background:"#f9fafb",borderRadius:12,border:"1px dashed #e5e7eb"}}>No asignaste tareas a otros todavía.</div>
      :USERS.filter(u=>u.id!==uid).map(u=>{
        ...
        return <div key={u.id} style={{marginBottom:24}}>
          ...
          {[...uItems].sort(sortPrio).map(item=>(
            <ItemCard key={item.id} item={{...item,assignedBy:null}}
              studentName={item.studentName} visitDate={item.createdAt}
              onResolve={item.status==="abierto"?resolveAssignedItem:undefined}
              onAddComment={addCommentAssigned} onDeleteComment={deleteCommentAssigned}
              onEditItem={item.status==="abierto"?editAssignedItemText:undefined}
              onDelete={deleteAssignedItem}/>
          ))}
        </div>;
      })}</>}
    {tab==="ami"&&<>{assignedToMe.length===0
      ?<div style={{textAlign:"center",padding:"48px",color:"#9ca3af",fontSize:14,background:"#f9fafb",borderRadius:12,border:"1px dashed #e5e7eb"}}>Nadie te asignó tareas todavía.</div>
      :[...new Set(assignedToMe.map(i=>i.assignedBy))].map(assignerName=>{
        ...
        const openN=aItems.filter(i=>i.status==="abierto").length;
        const doneN=aItems.filter(i=>i.status==="resuelto").length;
        return <div key={assignerName} style={{marginBottom:24}}>
          ...
          {[...aItems].sort(sortPrio).map(item=>{
            ...
            return <ItemCard key={item.id} item={item}
              ...
              onResolve={item.status==="abierto"?resolveItem:undefined}
              onAddComment={addComment} onDeleteComment={deleteComment}
              onEditItem={item.status==="abierto"?editItemText:undefined}/>;
          })}
        </div>;
      })}</>}
  </div>;
...
function LoginScreen({onSelect}) {
  return <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"linear-gradient(135deg,#f5f3ff 0%,#e0f2fe 100%)",fontFamily:"system-ui,sans-serif",padding:24}}>
    <div style={{marginBottom:40,textAlign:"center"}}>
      <div style={{width:72,height:72,borderRadius:18,background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 16px",boxShadow:"0 4px 20px rgba(0,0,0,.12)",overflow:"hidden"}}>
        <img src={LOGO_3F} alt="3F" style={{width:56,height:56,objectFit:"contain"}}/>
      </div>
      <div style={{fontSize:11,fontWeight:600,letterSpacing:"0.14em",textTransform:"uppercase",color:"#8b5cf6",marginBottom:6}}>Fundación 3F</div>
...
export default function App() {
  ...
  const [editLiceoModal,setEditLiceoModal] = useState(null);
  ...
  function saveStudLiceo(id,liceo){ const s=students.find(s=>s.id===id); if(!s)return; const u={...s,liceo}; setStudents(p=>p.map(x=>x.id===id?u:x)); fbSetStudent(id,u); setEditLiceoModal(null); }
  ...
  function deleteResolvedItem(itemId){
    setItems(p=>p.filter(i=>i.id!==itemId));
    try{ deleteDoc(uDoc(uid,"items",itemId)); }catch(e){console.error(e);}
  }
  ...
  const scheduledItems=items.filter(i=>i.status==="abierto"&&i.alertDate&&i.alertDate>today());
  const openItems=items.filter(i=>i.status==="abierto"&&(!i.alertDate||i.alertDate<=today()));
  ...
  return (
    <div style={{display:"flex",minHeight:"100vh",fontFamily:"system-ui,sans-serif",background:"#f8f9fb",position:"relative"}}>
      ...
      {editLiceoModal&&<EditLiceoModal student={editLiceoModal} onConfirm={liceo=>saveStudLiceo(editLiceoModal.id,liceo)} onCancel={()=>setEditLiceoModal(null)}/>}
      ...
      <aside style={{width:228,background:"#fff",borderRight:"1px solid #f3f4f6",display:"flex",flexDirection:"column",flexShrink:0,boxShadow:"2px 0 8px rgba(0,0,0,.06)",position:isMobile?"fixed":"sticky",top:0,left:0,height:"100vh",zIndex:45,transform:sidebarOpen?"translateX(0)":"translateX(-100%)",transition:"transform .22s ease"}}>
        <div style={{padding:"14px 18px 14px",borderBottom:"1px solid #f3f4f6",paddingLeft:56}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
            <div style={{width:28,height:28,borderRadius:7,background:"#fff",border:"1px solid #e5e7eb",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,overflow:"hidden"}}>
              <img src={LOGO_3F} alt="3F" style={{width:22,height:22,objectFit:"contain"}}/>
            </div>
            <div style={{fontSize:10,fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase",color:"#374151"}}>Fundación 3F</div>
          </div>
        ...
        <nav style={{flex:1,paddingTop:6,overflowY:"auto"}}>
          ...
          <NavBtn icon="ti-alert-triangle" label="Por prioridad" active={view==="priority"} badge={highPriorityItems.length}
            onClick={()=>navAndClose(()=>setView("priority"))} color="#b91c1c"/>
          <NavBtn icon="ti-calendar-time" label="Programadas" active={view==="programadas"} badge={scheduledItems.length}
            onClick={()=>navAndClose(()=>setView("programadas"))} color="#0ea5e9"/>
      ...
      <main style={{flex:1,overflow:"auto",paddingTop:isMobile?52:0}}>
        ...
        {view==="dashboard"&&(
          <div style={{padding:"28px",maxWidth:780}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:12,marginBottom:28}}>
              ...
              <StatCard label="Gestiones totales" value={visits.length} icon="ti-calendar-event" palette={PALETTE.sky} onClick={()=>setView("gestiones")}/>
              ...
              <StatCard label="Por prioridad" value={openItems.filter(i=>i.priority==="alta").length} icon="ti-alert-triangle" palette={openItems.filter(i=>i.priority==="alta").length>0?PALETTE.red:PALETTE.green} onClick={()=>setView("priority")}/>
                  ...
                  <div style={{flex:1,minWidth:0}}>
                    <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:5,flexWrap:"wrap"}}>
                      ...
                      <button onClick={e=>{e.stopPropagation();setEditCIModal(stud);}} style={{display:"flex",alignItems:"center",gap:4,fontSize:11,padding:"2px 8px",borderRadius:6,border:"1px solid #e5e7eb",background:"#f9fafb",color:"#6b7280",cursor:"pointer",fontWeight:500}}>
                        <i className="ti ti-id-badge" style={{fontSize:11}}/>{stud.ci?"CI":"+ CI"}
                      </button>
                      <button onClick={e=>{e.stopPropagation();setEditLiceoModal(stud);}} style={{display:"flex",alignItems:"center",gap:4,fontSize:11,padding:"2px 8px",borderRadius:6,border:"1px solid #e5e7eb",background:"#f9fafb",color:"#6b7280",cursor:"pointer",fontWeight:500}}>
                        <i className="ti ti-school" style={{fontSize:11}}/>{stud.liceo?"Liceo":"+ Liceo"}
                      </button>
                    </div>
              ...
              <div>
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:4,flexWrap:"wrap"}}>
                  ...
                  <button onClick={()=>setEditCIModal(selStud)} style={{display:"flex",alignItems:"center",gap:4,fontSize:11,padding:"3px 8px",borderRadius:6,border:"1px solid #e5e7eb",background:"#f9fafb",color:"#6b7280",cursor:"pointer",fontWeight:500}}>
                    <i className="ti ti-id-badge" style={{fontSize:11}}/>{selStud.ci?"CI":"+ CI"}
                  </button>
                  <button onClick={()=>setEditLiceoModal(selStud)} style={{display:"flex",alignItems:"center",gap:4,fontSize:11,padding:"3px 8px",borderRadius:6,border:"1px solid #e5e7eb",background:"#f9fafb",color:"#6b7280",cursor:"pointer",fontWeight:500}}>
                    <i className="ti ti-school" style={{fontSize:11}}/>{selStud.liceo?"Liceo":"+ Liceo"}
                  </button>
                </div>
          ...
          <div style={{padding:"28px",maxWidth:760}}>
            ...
            :(showResolved?resolvedFiltered:pendFiltered).map(item=>{
              ...
              return <ItemCard key={item.id} item={item} studentName={stud?.name} visitDate={v?.date}
                onResolve={!showResolved?resolveItem:undefined} onAddComment={addComment} onDeleteComment={deleteComment} onEditItem={!showResolved?editItemText:undefined} onDelete={showResolved?(iid=>{if(window.confirm("¿Eliminar?"))deleteResolvedItem(iid);}):undefined}/>;
            })}
          </div>
        )}

        {view==="asignadas"&&<AsignadasView
          uid={uid} items={items} visits={visits} students={students}
          assignedOutItems={assignedOutItems}
          resolveItem={resolveItem} addComment={addComment} deleteComment={deleteComment} editItemText={editItemText}
          resolveAssignedItem={resolveAssignedItem} addCommentAssigned={addCommentAssigned}
          deleteCommentAssigned={deleteCommentAssigned} editAssignedItemText={editAssignedItemText}
          deleteAssignedItem={deleteAssignedItem}
        />}

        {/* GESTIONES VIEW */}
        {view==="gestiones"&&(
          <div style={{padding:"28px",maxWidth:760}}>
            <button onClick={()=>setView("dashboard")} style={{background:"none",border:"none",cursor:"pointer",color:"#6b7280",fontSize:13,padding:"0 0 14px",display:"flex",alignItems:"center",gap:4,fontWeight:500}}>
              <i className="ti ti-arrow-left" style={{fontSize:13}}/> Inicio
            </button>
            <h1 style={{fontSize:22,fontWeight:700,margin:"0 0 6px",color:"#111827"}}>Gestiones totales</h1>
            <div style={{fontSize:13,color:"#6b7280",marginBottom:22}}>{visits.length} gestión{visits.length!==1?"es":""} registrada{visits.length!==1?"s":""}</div>
            {visits.length===0?<div style={{textAlign:"center",padding:"48px",color:"#9ca3af",fontSize:14,background:"#f9fafb",borderRadius:12,border:"1px dashed #e5e7eb"}}>No hay gestiones registradas.</div>
            :[...visits].sort((a,b)=>b.date.localeCompare(a.date)).map(visit=>{
              const stud=students.find(s=>s.id===visit.locationId);
              const vis=items.filter(i=>i.visitId===visit.id);
              const oc=vis.filter(i=>i.status==="abierto").length;
              const bl=(visit.bullets||[]).filter(b=>b.trim());
              return <div key={visit.id} style={{background:"#fff",border:"1px solid #f3f4f6",borderRadius:12,padding:"14px 16px",marginBottom:8,boxShadow:"0 1px 3px rgba(0,0,0,.04)"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                  <div>
                    <div style={{fontSize:14,fontWeight:700,color:"#111827",marginBottom:2}}>{fmt(visit.date)}</div>
                    {stud&&<div style={{fontSize:12,color:"#8b5cf6",fontWeight:500,marginBottom:bl.length?4:0,display:"flex",alignItems:"center",gap:4}}>
                      <i className="ti ti-user" style={{fontSize:11}}/>{stud.name}
                      {stud.liceo&&<LiceoChip liceo={stud.liceo} size="sm"/>}
                    </div>}
                    {bl.length>0&&<BulletDisplay bullets={bl}/>}
                  </div>
                  <div style={{display:"flex",gap:8,alignItems:"center",flexShrink:0,marginLeft:12}}>
                    {vis.length>0&&<span style={{fontSize:11,fontWeight:600,color:oc>0?"#b45309":"#166534",background:oc>0?"#fffbeb":"#f0fdf4",padding:"2px 8px",borderRadius:8,border:`1px solid ${oc>0?"#fcd34d":"#86efac"}`}}>{oc>0?`${oc} abierta${oc!==1?"s":""}` :"✓ Todo ok"}</span>}
                    <button onClick={()=>{setSelStudId(visit.locationId);setView("student");}} style={{fontSize:12,padding:"4px 10px",border:"1px solid #e5e7eb",background:"#f9fafb",color:"#6b7280",borderRadius:7,cursor:"pointer"}}>Ver alumno</button>
                  </div>
                </div>
              </div>;
            })}
        ...
        {view==="programadas"&&(
          <div style={{padding:"28px",maxWidth:760}}>
            <h1 style={{fontSize:22,fontWeight:700,margin:"0 0 6px",color:"#111827"}}>Tareas Programadas</h1>
            <div style={{fontSize:13,color:"#6b7280",marginBottom:22}}>Se activan automáticamente cuando llega la fecha programada</div>
            {scheduledItems.length===0
              ?<div style={{textAlign:"center",padding:"48px",color:"#9ca3af",fontSize:14,background:"#f9fafb",borderRadius:12,border:"1px dashed #e5e7eb"}}>No hay tareas programadas.</div>
              :[...scheduledItems].sort((a,b)=>(a.alertDate||"").localeCompare(b.alertDate||"")).map(item=>{
                const stud=students.find(s=>s.id===item.locationId);const v=visits.find(v=>v.id===item.visitId);
                return <div key={item.id} style={{background:"#fff",border:"1px solid #7dd3fc",borderLeft:"3px solid #0ea5e9",borderRadius:12,padding:"14px 16px",marginBottom:8}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                    <div style={{display:"flex",flexWrap:"wrap",gap:6,alignItems:"center"}}>
                      <TypeBadge type={item.type}/>
                      {item.priority&&item.priority!=="media"&&<PriorityBadge priority={item.priority}/>}
                      <span style={{fontSize:11,color:"#0369a1",background:"#f0f9ff",padding:"1px 8px",borderRadius:8,border:"1px solid #7dd3fc",display:"flex",alignItems:"center",gap:3}}>
                        <i className="ti ti-calendar-time" style={{fontSize:11}}/>Se activa: {fmt(item.alertDate)}
                      </span>
                    </div>
                  </div>
                  <p style={{margin:"0 0 6px",fontSize:14,color:"#111827"}}>{item.description}</p>
                  {stud&&<div style={{fontSize:12,color:"#6b7280",display:"flex",alignItems:"center",gap:4}}><i className="ti ti-user" style={{fontSize:11}}/>{stud.name}</div>}
                </div>;
              })}
          </div>
        )}
